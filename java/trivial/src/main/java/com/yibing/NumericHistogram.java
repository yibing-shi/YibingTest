...
public class NumericHistogram {
  ...
  public static void main(String[] args) {
    ...
    histogram.allocate(10);
    //histogram.add(1);
    histogram.add(668.2832202);
    histogram.add(1263.736264);
    histogram.add(1917.321597);
    histogram.add(2570.909091);
    System.out.println(histogram.quantile(0.5));
  }
}
